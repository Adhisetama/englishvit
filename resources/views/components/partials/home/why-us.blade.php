...
<x-common.content-container class="py-15">
    <h2 class="text-neutral-dark font-bold text-2xl text-center">Why Englishvit?</h2>
        ...
        <div class="swiper-wrapper">
            ...
            @foreach ($why_us as $why)
                <div class="swiper-slide px-10">
                    <x-common.card
                        class="flex flex-col md:flex-row gap-5 px-5 py-8 text-center text-neutral-darkgray items-center md:text-left md:items-start">
